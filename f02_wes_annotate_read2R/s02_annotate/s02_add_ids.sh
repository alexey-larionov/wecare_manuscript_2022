...
# Files
source_vcf="${data_folder}/wecare_nfe_nov2016_vqsr_shf_split_clean_tag_ac.vcf.gz"
id_vcf="${data_folder}/wecare_nfe_nov2016_vqsr_shf_split_clean_tag_ac_id.vcf.gz"
id_log="${data_folder}/wecare_nfe_nov2016_vqsr_shf_split_clean_tag_ac_id.log"
