---
title: "Ampliseq wecare only: clean variant annotations"
...
Downsampling was suppressed by the GATK pipeline because this was ampliseq data.  Then I explicitly verified that "DS" filed in the input VCF contained dots only.  Somehow these dots in DS field were interpreted as TRUE when reading of the data to data-frames.  So, these values are misleading.  No other mis-interpretations of the data were noted under the visual inspection after reading into vcfR.    
