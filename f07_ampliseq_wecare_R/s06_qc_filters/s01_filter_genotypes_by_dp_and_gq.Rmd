---
title: "Ampliseq wecare only: filter genotypes by dp and gq"
...
Remove (set to NA) ~ 20% genotypes.  

Genotypes removed if any of these conditions is true:  

- gq < 20  : ~12% genotypes
- dp < 10  : ~6% genotypes more
- dp > 1100  : ~2% genotypes more, 10x mean dp (was 360 in WES)

Then remove non-polymorphic sites, if appear after the genotypes filtering.  

gq 20 filter is set arbitrary; however, it is consistent with what some other papers 
...
Input data: 6,839 variants x 389 samples (194UBC + 195CBC)  
Output data: 5,635 variants x 389 samples (194UBC + 195CBC)  
