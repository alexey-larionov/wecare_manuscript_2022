...
data_folder="${project_folder}/ampliseq/data/s00_source_data"
stats_folder="${data_folder}/stats"
rm -fr "${stats_folder}"
mkdir "${stats_folder}"
scripts_folder="${project_folder}/ampliseq/scripts/s00_check_source_data"
cd "${scripts_folder}"

# Files
vcf="${data_folder}/s12_hard_filters/ampliseq_nfe_locID_MAflag_vqsr_hf.vcf"
stats_file="${stats_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf.vchk"
