...
# Split VEP annotations to separate columns
...
# Files
source_vcf="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep.vcf.gz"
split_vcf="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep_split.vcf.gz"
split_log="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep_split.log"
rm_vcf="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep_split_rm.vcf.gz"
rm_log="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep_split_rm.log"
