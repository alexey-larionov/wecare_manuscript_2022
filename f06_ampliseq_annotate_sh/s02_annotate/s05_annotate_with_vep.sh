...
# Files
source_vcf="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar.vcf.gz"
vep_vcf="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep.vcf.gz"
vep_log="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep.log"
vep_report="${data_folder}/ampliseq_nfe_locID_MAflag_vqsr_hf_split_clean_tag_ac_id_clinvar_vep.html"
