...
load(file.path(project_folder,"wes","s01_wes_wecare_only","data","s06_qc_filters","s04_filter_by_sample_call_rates.RData"))
...
Data from bed-bim-fam only: explored; is not needed for calculation here
