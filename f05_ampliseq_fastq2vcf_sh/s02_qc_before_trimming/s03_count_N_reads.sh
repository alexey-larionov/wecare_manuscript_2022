...
fastq_folder="${base_folder}/data_and_results/s01_source_data/fastq"
output_folder="${base_folder}/data_and_results/s02_qc_before_trimming/count_N_reads"
...
cd "${fastq_folder}"
R1_fastq_files=$( ls *R1_001.fastq.gz )
R2_fastq_files=$( ls *R2_001.fastq.gz )
