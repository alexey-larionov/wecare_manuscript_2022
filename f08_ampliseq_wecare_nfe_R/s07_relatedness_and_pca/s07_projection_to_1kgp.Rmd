---
title: "Projecting Ampliseq NFFE w/o Danish on 1KGP"
...
table(wecare_phenotypes.df$affection, useNA="always")
...
plot(z[,1:2],col=z[,3], xlab="PC1", ylab="PC2",
     main="Projecting WECARE w/o Danish to 1KGP\nusing only 83 variants")
text(-4.5,0,"AFR")
text(2,-3,"EAS")
text(1,-1,"AMR/SAS")
text(1,3,"EUR")

legend("topleft",legend="WECARE NFFE Ampliseq", pch=1, col ="red", bty="n")
